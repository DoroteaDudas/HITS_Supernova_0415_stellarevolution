...
RUN /usr/local/bin/replace-with-nonfree-files.sh \
        "https://supernova.eso.org/exhibition/storage/interactives_0415_risinger_milky4k.jpg" \
        "/I/Images/Milky4k.jpg" \
    && /usr/local/bin/replace-with-nonfree-files.sh \
        "https://supernova.eso.org/exhibition/storage/interactives_0415_risinger_milky4k_flipped_dark2.jpg" \
        "/I/Images/Milky4k_flipped_dark2.jpg"
...
LABEL maintainer="Volker Gaibler <volker.gaibler@h-its.org>" \
    org.label-schema.name="Stellar Evolution" \
